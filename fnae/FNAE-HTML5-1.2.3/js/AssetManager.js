...
class AssetManager {
    ...
    getBasePath() {
        // for those who want to port to their own site, modify this, 
        // and the base tag in the index.html that is inside FNAE-HTML5-1.2.3/
        return '/fnae/FNAE-HTML5-1.2.3/';
    }
